...
<div class="form1">
	...
	<div class="col-lg-6 form-info">
		...
		<form method="post" action="setting_script.php" class="needs-validation" novalidate>
			<div class="form-group">
			<label for="oldpass">Old Password:</label>
				<input type="password" class="form-control" id="oldpass" placeholder="Old password" name="oldPassword" required>
