...
$left = $_POST['left'];
$right = $_POST['right'];
$results = $con->prepare('SELECT * FROM items WHERE id > :item_id AND price BETWEEN :left AND :right LIMIT 9');
				...
				else
				{
					$output .= '<div class="col-lg-4 col-sm-6">
								...
								<div class="pi-pic">	
									<a href="product.php?id='. $row['id'] .'"><img src="img/'. $row['path'] .'" alt="image"></a>	
									<div class="pi-links">
							<a href="cart_add.php?id='. $row['id'] .'" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
							</div>
							</div>
						<div class="pi-text">
